...
public class Pedido implements Comparable<Pedido> {
	...
	private Lista<ItemDePedido> listaPedidos;
	...
	public ItemDePedido existeNoPedido(Produto produto) {
		CriterioDeBuscaPorDescricao criterio;
		...
		listaPedidos.buscarPor(CriterioDeBuscaPorDescricao::compare,itemDePedidoProcurado);
